...
describe("__subtract__", () => {
  it("should take a date, unit of time, and a quantity and subtract", () => {
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 'd', 1))
      .toStrictEqual(new Date('2021-05-25T20:17:56.511Z'));
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 'd', 2))
      .toStrictEqual(new Date('2021-05-24T20:17:56.511Z'));
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 'd', 11))
    ...
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 'y', 1))
      .toStrictEqual(new Date('2020-05-26T20:17:56.511Z'));
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 'y', 2))
      .toStrictEqual(new Date('2019-05-26T20:17:56.511Z'));
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 'y', 11))
      .toStrictEqual(new Date('2010-05-26T20:17:56.511Z'));

    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 'h', 1))
      .toStrictEqual(new Date('2021-05-26T19:17:56.511Z'));
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 'h', 2))
      .toStrictEqual(new Date('2021-05-26T18:17:56.511Z'));
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 'h', 11))
    ...
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 's', 1))
      .toStrictEqual(new Date('2021-05-26T20:17:55.511Z'));
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 's', 2))
      .toStrictEqual(new Date('2021-05-26T20:17:54.511Z'));
    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 's', 11))
      .toStrictEqual(new Date('2021-05-26T20:17:45.511Z'));

    expect(subtract(new Date('2021-05-26T20:17:56.511Z'), 'w', 1))
